  ...
  return (
    <div className="navbar">
      ...
      <div className="navbar-btn">
        ...
        <Link to="/aboutus" className="Nlink abt-pos"><a>About Us</a></Link>
        <div className="dropdown-content">
       <a href="history" className='about-link'>Our History</a>
       <a href='#mission' className='about-link'>Mission</a>
       <a href='#relief' className='about-link'>Relief Activiies</a>
       <a href='#partners' className='about-link'>Partners</a>
       <a href='#sponsor' className='about-link'>Sponsor</a>
   </div>
        </div>
